...
ТегиКЦ, Вариация, Препарат, Статус детальный, Задача, **Кто рекомендовал** (+ комментарий при необходимости).

**Кто рекомендовал** (`UF_CRM_1711919555`): CoPilot с августа 2026 часто не срабатывает (#24618) — подстраховка здесь. Спросили — не назвал → `474`. Повторный пациент → `470`/`472`. Сомнение → не писать.
